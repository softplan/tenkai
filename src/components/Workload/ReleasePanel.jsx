...
export class ReleasePanel extends Component {
  ...
  handleConfirmRollback() {
    rollbackHelmRelease(
      this,
      this.props.selectedEnvironment.value,
      this.state.itemToRollback,
      self => {
        this.setState(
          { showConfirmRollbackModal: false, itemToRollback: {} },
          () => {
    ...
    return (
      <Card eventKey={this.props.eventKey}>
        ...
        <SimpleModal
          ...
          handleConfirmDeleteModalClose={this.handleConfirmRollbackClose.bind(
            this
          )}
          title="Confirm"
        ...
        <Accordion.Collapse eventKey={this.props.eventKey}>
          <Card.Body>
            ...
            <ButtonToolbar>
              ...
              >
                <i className="pe-7s-keypad" /> Blue/Green or Canary Strategy
                Wizard
              </Button>
            </ButtonToolbar>
