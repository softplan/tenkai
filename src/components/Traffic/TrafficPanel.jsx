...
import { CardGroup, Card, Row, Col, FormGroup } from 'react-bootstrap';
...
export class TrafficPanel extends Component {
  ...
  async applyByWeight() {
    ...
    axios
      .post(TENKAI_API_URL + '/deployTrafficRule', data)
      .then(res => {
                  ...
                  <CardGroup accordion="true" id="accordion-example">
                          ...
                          <FormInputs
                            ...
                            properties={[
                              ...
                              },
                              {
                                ...
                                onChange: this.handleHeaderValueChange.bind(
                                  this
                                )
                              }
                            ]}
                            ...
                            properties={[
                              {
                                ...
                                onChange: this.handleHeaderReleaseNameChange.bind(
                                  this
                                )
                              }
                            ]}
                            ...
                            properties={[
                              {
                                ...
                                onChange: this.handleDefaultReleaseNameChange.bind(
                                  this
                                )
                              }
                            ]}
                    ...
                    <Card eventKey="2">
                      ...
                      <Card.Body collapsible>
                        <Row>
                          <Col md={10}>
                            <FormGroup>{releases}</FormGroup>
                            <Button
                              variant="info"
                              onClick={this.addRelease.bind(this)}
                            >
                              Add Release
                            </Button>
                          </Col>
