...
import { Tabs, Tab, ButtonToolbar, Row, Col } from "react-bootstrap";
...
class DepGraph extends Component {
  ...
  onInstallUpdateAllClick() {
    ...
    for (let x = 0; x < totalCharts; x++) {
      let scope = this.state.data.nodes[x].id.substring(
        0,
        this.state.data.nodes[x].id.indexOf(":")
      );
      ...
      installPayloadConfigMap.chart = "/dotnet-global-variables";
                    ...
                    <div>
                      ...
                      <ButtonToolbar>
                        <Button
                          ...
                          pullRight
                          type="button"
                          onClick={this.onInstallUpdateAllClick.bind(this)}
                        >
                          Install/Update All
                        </Button>
                      </ButtonToolbar>
              ...
              <Tab
                ...
                title={
                  <span>
                    {chartName}{" "}
                    <FontAwesomeIcon
                      onClick={this.onTabClose.bind(this, index)}
                      icon="window-close"
                    />
                  </span>
                }
                      ...
                      <div>
                        <ButtonToolbar>
                          ...
                          <Button
                            ...
                            pullRight
                            type="button"
                            onClick={this.onInstallUpdateChartClick.bind(
                              this,
                              chartName
                            )}
                          >
                          ...
                          <Button
                            ...
                            pullRight
                            type="button"
                            onClick={this.onSaveVariablesClick.bind(
                              this,
                              chartName
                            )}
                          >
